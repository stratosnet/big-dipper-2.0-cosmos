...
const customTypeToModel = {
  ...
  '/stratos.register.v1.MsgUpdateResourceNodeDeposit': {
    ...
    tagTheme: 'two',
    tagDisplay: 'txUpdateResourceNodeDepositLabel',
  },
  // ========================
  // sds
  // ========================
